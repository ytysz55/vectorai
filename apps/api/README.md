...
- `GET /v1/jobs/{job_id}/preview.svg` — inline, sandboxed SVG for an **E7 validated job only**; enforces the same artifact-path guard and is not a PDF or external baseline renderer claim. Legacy demo output cannot use this route.
